...
const daniel
Student = new Student("Daniel", 22, ["NodeJs", "Python"])
...
const myRepo = new Repository("LaunchX", "DanyVeneno", "js", 18)
...
const danielDev = new Developer("Daniel", "js", ["node", "vue", "react"])
...
console.log(danielLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija
...
const viajero1 = new Viajero("Daniel", "LaunchX", "Node JS", "Abril 2022")
